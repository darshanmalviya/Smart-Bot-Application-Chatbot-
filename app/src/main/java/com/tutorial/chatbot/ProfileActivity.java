...
public class ProfileActivity extends AppCompatActivity {
    ...
    public String getImageURIacessToken() {
        return ImageURIacessToken;
    }

    public void setImageURIacessToken(String imageURIacessToken) {
        ImageURIacessToken = imageURIacessToken;
    }
}